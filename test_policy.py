...
calm = {"available": True, "energy": 0.15, "valence": 0.78, "bpm": 75, "loudness": -25, "instrumentalness": 0.95}
harsh = {"available": True, "energy": 0.95, "valence": 0.1, "bpm": 175, "loudness": -3, "instrumentalness": 0.9}
print("  calm  ->", affect_for(calm), "| has_vocals:", ac.has_vocals(calm))
print("  harsh ->", affect_for(harsh), "| has_vocals:", ac.has_vocals(harsh))
